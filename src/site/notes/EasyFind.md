---
{"dg-publish":true,"permalink":"/easy-find/","noteIcon":"2","dg-note-properties":{"creation_date":"20230302"}}
---
...
## Cons
- Regex search is always case-sensitive and there's no setting to make it case-insensitive. e.g. must do `[Dd]epartment` in order to find either `Department` or `department`
