---
{"dg-publish":true,"permalink":"/anki-to-mochi-to-obsidian/","tags":["#paste/glasp","#Anki","#Mochi","#Obsidian","#project/learn-by-doing","#project/started","#project/completed"],"noteIcon":"2"}
---
